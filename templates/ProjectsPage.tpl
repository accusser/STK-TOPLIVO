                ...
                <div class="services_second_level_section5_question_answers_rows" style="height: 80px;">
                    <div class="services_second_level_section5_question_answers_row1">
                        ...
                        <div class="services_second_level_section5_question_answers_rows_col2">
                            <div class="services_second_level_section5_question_answers_rows_col2_line_horizontal"
                                style="transform: rotate(0deg);"></div>
                            <div class="services_second_level_section5_question_answers_rows_col2_line_vertically"
                    ...
                    <div class="project_second_level_section2_col2_row2">
                        ...
                        <div class="project_second_level_section3_col2_content_row2">
                            <div class="project_second_level_section3_col2_content_row2_col1">
                                ...
                                <div class="project_second_level_section3_col2_content_row2_col1_position">Менеджер
                                </div>
        ...
        <div class="section_5_content">
            <div class="section_5_header_col2_mobile_header">
                <div class="section_5_content_col1">
                    <div class="section_5_content_col1_LefRight" id="project_slide_left" tabindex="0" role="button"
                        aria-label="Previous slide" aria-controls="swiper-wrapper-b573505eea106aa19"
                        aria-disabled="false">
                        <img src="/icons/arrow_left_26.svg" alt="">
                    </div>

                    <div class="section_5_content_col1_LefRight swiper-button-disabled" id="project_slide_Right"
                        tabindex="-1" role="button" aria-label="Next slide"
                        aria-controls="swiper-wrapper-b573505eea106aa19" aria-disabled="true">
            ...
            <div class="section_5_content_slider">
                <div
                    class="swiper-container_all_project_slide swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                    <div class="swiper-wrapper" id="swiper-wrapper-b573505eea106aa19" aria-live="polite"
                        style="transform: translate3d(-501.333px, 0px, 0px); transition-duration: 0ms;">
