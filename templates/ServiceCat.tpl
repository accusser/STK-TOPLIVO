...
<div class="mobile_for_hiden_content">
    ...
    <div class="products_content">
        ...
        <div class="container">
            ...
            <div class="products_third_level_section_tables_block">
                <div class="section_3_content_item_header">
                    <span class="with_red_dot">Продукция карьера</span>
                </div>
                [[getImageList? &tvname=`table` &tpl=`TableTpl`]]
            </div>
            {'!PageBlocks' | snippet}
        </div>
    </div>
